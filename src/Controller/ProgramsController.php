...
class ProgramsController extends AppController
{
    ...
    public function view($id = null)
    {
        $program = $this->Programs->get($id, [
            'contain' => ['Meetings', 'Types', 'Evidences']
        ]);
    ...
    public function add()
    {
        ...
        $meetings = $this->Programs->Meetings->find('list', ['limit' => 200]);
        $types = $this->Programs->Types->find('list', ['limit' => 200]);
        $evidences = $this->Programs->Evidences->find('list', ['limit' => 200]);
        $this->set(compact('program', 'meetings', 'types', 'evidences'));
        $this->set('_serialize', ['program']);
    }
